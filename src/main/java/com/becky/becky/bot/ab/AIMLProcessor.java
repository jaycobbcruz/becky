package com.becky.becky.bot.ab;
...
import com.becky.becky.bot.ab.utils.*;
...
public class AIMLProcessor {
	...
	private static String sraix(Node node, ParseState ps) {
		...
		String index = getAttributeOrTagValue(node, ps, "collection");
		String query = getAttributeOrTagValue(node, ps, "query");
		...
		String star = inputStar(node, ps);
		String result = Sraix.sraix(ps.chatSession, evalResult, star, defaultResponse, hint, index, query, host, botid, null, limit);
		return result;
	 ...
	 */
	public static String inputStar(Node node, ParseState ps) {
		String result = "";
