...
import com.becky.becky.bot.ab.utils.CalendarUtils;
import com.becky.becky.bot.ab.utils.NetworkUtils;
...
public class Sraix {
	...
	public static String sraix(Chat chatSession, String input, String star, String defaultResponse, String hint, String index,
                               String query, String host, String botid, String apiKey, String limit) {
		String response;
